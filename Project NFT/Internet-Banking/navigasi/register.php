 ...
 <div class="edit_profile_nsb">
     ...
     <?php
      ...
      if (isset($simpan) && $nama_usr && $pas_usr && $tgl && $bln && $thn && $alamat_usr && $email && $no_hp === true) {
         $kalimat_query = $kon -> prepare("insert into nasabah (NAMA_NSB, USERNAME_NSB, USERNAME_ADMIN, PASSWORD_NSB, TGL_NSB, ALAMAT_NSB, EMAIL_NSB, NO_HP_NSB) 
         VALUES (:nama_nsb,:username, :admin, SHA2 (:pass_nsb, 0), :tgl, :alamat, :email, :no_hp)");
